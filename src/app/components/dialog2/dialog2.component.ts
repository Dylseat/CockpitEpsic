...
export class Dialog2Component implements OnInit{
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data:any ,private dialogRef: MatDialogRef<Dialog2Component>, private moduleService: ModuleService,) {}

  // Récupérez les modules de la base de données
  ngOnInit(): void {
    // Appelez la méthode du service pour récupérer les modules
    this.moduleService.getModules2annes().subscribe(modules => {
