...
@Component({
	selector: 'app-notes3-branches-table',
	standalone: true,
	imports: [MatTableModule, MatInputModule, FormsModule, CommonModule],
	templateUrl: './notes3-branches-table.component.html',
	styleUrls: ['./notes3-branches-table.component.scss']
})

export class Notes3BranchesTableComponent {
	...
	constructor(private branchesData2Service: BranchesData3Service) {}
